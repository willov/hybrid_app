...
anthropometrics["age"] = st.number_input("Age (years):", 0.0, 100.0, 1.0, key="age") # max, min 
anthropometrics["height"] = st.number_input("Height (m):", 0.0, 2.5, 0.1, st.session_state['height'], key="height") # st.session_state['height'], 0.1, 
